...
const deployment = (scope, id) => {
  ...
  const PIPELINE_NAME = `${id}-PIPELINE`;
    ...
    const templateFile = 'AWS-CODEPIPELINE-TEST-LAMBDA-STACK.template.json';
    ...
    const bucket =  s3.Bucket.fromBucketName(scope, `${id}-ARTIFACT-BUCKET`, project_constants.DEPLOYMENT_BUCKET_NAME);
    bucket.grantWrite(cdkBuild);
        ...
        },
        {
          ...
          actions: [
            new codepipeline_actions.CloudFormationCreateUpdateStackAction({
              ...
              stackName: 'AWS-CODEPIPELINE-TEST-LAMBDA-STACK',
